...
export default {
  init ({ commit, dispatch }, item) {
    return new Promise((resolve, reject) => {
      ...
      axios.get('http://xmax-sgd.getsandbox.com/app-admin/api/usuarios/inicializar', {
        headers: {
